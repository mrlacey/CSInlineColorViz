...
internal sealed class SvgTagger : RegexTagger<ColorTag>, ITestableRegexColorTagger
{
	...
	internal SvgTagger(ITextBuffer buffer)
	...
	{
		if (lineText.Contains(match.Value) && match.Groups.Count == 5)
		{
