...
internal sealed class ColorFromIntTagger : RegexTagger<ColorTag>, ITestableRegexColorTagger
{
	internal static Regex regularExpression = new(@"(Microsoft.Maui.Graphics.Color.FromInt\(|Color.FromInt\(|Microsoft.Maui.Graphics.Color.FromUint\(|Color.FromUint\()([0-9]{1,})(\))", RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
