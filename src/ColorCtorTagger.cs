...
{
	internal static Regex regularExpression = new(@"(new Color\(|new Microsoft.Maui.Graphics.Color\()([0-9]{1,3})(,{1} ?)([0-9]{1,3})(,{1} ?)([0-9]{1,3})(\))", RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
