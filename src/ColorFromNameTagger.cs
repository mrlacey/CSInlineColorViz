...
internal sealed class ColorFromNameTagger : RegexTagger<ColorTag>, ITestableRegexColorTagger
{
	internal static Regex regularExpression = new(@"(System.Drawing.Color.FromName\(""|Color.FromName\("")([a-z,A-Z]{3,})(""\))", RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.IgnoreCase);
